...
const ERROR_MESSAGES = {
  ...
  [ERROR_CODES.SERIAL_NOT_FOUND]: "Serial not found in the database",
  ...
  [ERROR_CODES.INVALID_SERIAL]: "Invalid Serial format",
